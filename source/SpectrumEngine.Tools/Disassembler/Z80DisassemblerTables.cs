...
public partial class Z80Disassembler
{
    ...
    /// </summary>
    private static readonly InstructionTable s_StandardInstructions = new(
    ...
    private static readonly InstructionTable s_ExtendedInstructions = new InstructionTable(
        new List<OperationMapBase>
        {
            new MaskedOperationMap(0x00, 0xE0),
            new SingleOperationMap(0x20),
            new SingleOperationMap(0x21),
            new SingleOperationMap(0x22),
            new SingleOperationMap(0x23, "swapnib", true),
            new SingleOperationMap(0x24, "mirror a", true),
            new SingleOperationMap(0x25),
            new SingleOperationMap(0x26, "mirror de", true),
            new SingleOperationMap(0x27, "test ^B", true),
            new MaskedOperationMap(0x28, 0xF8),
            ...
            new SingleOperationMap(0x37),
            new SingleOperationMap(0x38),
            new SingleOperationMap(0x39),
            new SingleOperationMap(0x3A),
            new SingleOperationMap(0x3B),
            new SingleOperationMap(0x3C),
            new SingleOperationMap(0x3D),
            new SingleOperationMap(0x3E),
            new SingleOperationMap(0x3F),
            ...
            new SingleOperationMap(0x77),
            new SingleOperationMap(0x7E, "im 2"),
            new SingleOperationMap(0x7F),
            new MaskedOperationMap(0x80, 0xF8),
            new SingleOperationMap(0x88),
            new SingleOperationMap(0x89),
            new SingleOperationMap(0x8A, "push ^W", true),
            new SingleOperationMap(0x8B),
            new SingleOperationMap(0x8C),
            new SingleOperationMap(0x8D),
            new SingleOperationMap(0x8E),
            new SingleOperationMap(0x8F),
            ...
            new SingleOperationMap(0x96),
            new SingleOperationMap(0x97),
            new MaskedOperationMap(0x98, 0xF8),
            ...
            new SingleOperationMap(0xAD),
            new SingleOperationMap(0xAE),
            new SingleOperationMap(0xAF),
            ...
            new SingleOperationMap(0xBD),
            new SingleOperationMap(0xBE),
            new MaskedOperationMap(0xC0, 0xC0),
        });
