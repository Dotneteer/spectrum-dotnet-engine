...
public partial class NECUPD765
{
    ...
    {
        // z80 timing
        double frameSize = _machine.TactsInFrame;
        double rRate = _machine.BaseClockFrequency / frameSize;
        ...
        long TStatesPerDriveCycle = (long)((double)_machine.BaseClockFrequency / DriveClock);
    ...
    {
        // get delta
        ulong delta = CurrentCPUCycle - LastCPUCycle;
